...
export const USE_CASES = [
  ...
  {
    slug: 'subaddress-swap',
    href: '/dashboard/subaddress-swap',
    title: 'Sub-Address Swapping via JWT',
    summary: "Same four teams and workspaces as Team Swapping, but the team follows WHICH LOGIN the embed user is signed in as — the identity itself re-signs both the sub and teams claims, not a picker inside one session.",

 ...
 * LegacySidebar is NOT repointed — it's a separate REST-API-driven feature
 * added after the switch, and this org's REST API credentials/region
 * weren't verified working, so it deliberately still reflects the current
 * (new) org.
 */
